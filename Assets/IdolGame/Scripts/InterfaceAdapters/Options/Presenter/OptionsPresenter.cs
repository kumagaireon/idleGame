...
namespace IdolGame.Options.Presenter;

public sealed class OptionsPresenter:IAsyncStartable
{
    // ログ記録用のロガー
    readonly ILogger<OptionsPresenter> logger;
    ...
    public OptionsPresenter(ILogger<OptionsPresenter> logger,
