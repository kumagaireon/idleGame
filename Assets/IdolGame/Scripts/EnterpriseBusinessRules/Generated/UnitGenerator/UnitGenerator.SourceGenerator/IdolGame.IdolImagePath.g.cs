...
namespace IdolGame
{
    [JsonConverter(typeof(IdolImagePathJsonConverter))]
    [System.ComponentModel.TypeConverter(typeof(IdolImagePathTypeConverter))]
    readonly partial struct IdolImagePath 
        : IEquatable<IdolImagePath>
#if NET8_0_OR_GREATER
        , IEqualityOperators<IdolImagePath, IdolImagePath, bool>
#endif
    {
        ...
        private class IdolImagePathJsonConverter : JsonConverter<IdolImagePath>
        {
        ...
        private class IdolImagePathTypeConverter : System.ComponentModel.TypeConverter
        {
