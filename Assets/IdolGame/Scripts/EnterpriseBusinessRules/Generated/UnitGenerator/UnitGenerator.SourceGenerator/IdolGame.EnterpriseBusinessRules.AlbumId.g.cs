...
namespace IdolGame.EnterpriseBusinessRules
{
    ...
    readonly partial struct AlbumId 
        : IEquatable<AlbumId>
        , IFormattable
#if NET8_0_OR_GREATER
        , IEqualityOperators<AlbumId, AlbumId, bool>
#endif
    {
        readonly int value;
        ...
        public static implicit operator int(AlbumId value)
        {
            return value.value;
        }

        public static implicit operator AlbumId(int value)
        {
        ...
        public static bool operator ==(AlbumId x, AlbumId y)
        {
        ...
        private class AlbumIdJsonConverter : JsonConverter<AlbumId>
        {
            ...
            public override AlbumId Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                ...
                if (converter != null)
                {
                    return new AlbumId(converter.Read(ref reader, typeToConvert, options));
                }
                else
                {
                    throw new JsonException($"{typeof(int)} converter does not found.");
        ...
        {
            private static readonly Type WrapperType = typeof(AlbumId);
            ...
            {
                if (value is AlbumId wrappedValue)
                {
